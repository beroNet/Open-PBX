...
function _ext_add_section_beroPBX ($ba) {
...
// create file extensions_beroPBX.conf
function create_ext_beroPBX ($ba, $ami) {

	$fn = BAF_APP_AST_CFG . '/extensions_beroPBX.conf';

	$cont = "; Generated by beroPBX 'create_files_ext.php'\n" .
		_ext_add_section_beroPBX($ba) .
...
function create_ext () {
	...
	$cont =	"[general](+)\n" .
		...
		"exten=>s,n,HangUp\n" .
		"\n" .
		"#include " . BAF_APP_AST_CFG . "/extensions_beroPBX.conf\n";
