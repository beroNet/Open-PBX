...
INSERT INTO activate VALUES('activate',0);
CREATE TABLE sip_extensions (id INTEGER AUTOINCREMENT PRIMARY KEY,extension VARCHAR(16) NOT NULL DEFAULT '0');
INSERT INTO sip_extensions VALUES(0,'Any Extension');
CREATE TABLE sip_users (id INTEGER AUTOINCREMENT PRIMARY KEY,name VARCHAR(64) NOT NULL DEFAULT '',extension INTEGER NOT NULL DEFAULT '0',password VARCHAR(256) NOT NULL DEFAULT '',voicemail INTEGER(1) NOT NULL DEFAULT 0,mail VARCHAR(256) NOT NULL DEFAULT '',details VARCHAR(512) NOT NULL DEFAULT '',CONSTRAINT fk_sip_extensions_id FOREIGN KEY(extension) REFERENCES sip_extensions(id) ON DELETE SET DEFAULT);
...
INSERT INTO mail_settings VALUES(1,'',25,'','','');
CREATE TABLE phone_types (id INTEGER PRIMARY KEY, name VARCHAR(60));
INSERT INTO phone_types VALUES(1,'snom300');
INSERT INTO phone_types VALUES(2,'snom320');
INSERT INTO phone_types VALUES(3,'snom360');
INSERT INTO phone_types VALUES(4,'snom370');
INSERT INTO phone_types VALUES(5,'snom720');
INSERT INTO phone_types VALUES(6,'snom760');
INSERT INTO phone_types VALUES(7,'snom820');
INSERT INTO phone_types VALUES(8,'snom821');
INSERT INTO phone_types VALUES(9,'snom870');
...
INSERT INTO phone_templates VALUES(1,'snom_default','SNOM default template','/apps/OpenPBX/etc/settings/default/snom.xml',1);
CREATE TABLE phone_pnp_managed (id INTEGER AUTOINCREMENT PRIMARY KEY, mac VARCHAR(12), enabled INTEGER(1) NOT NULL DEFAULT '0');
INSERT INTO phone_pnp_managed VALUES(0,'FFFFFFFFFFFF',0);
CREATE TABLE sip_dtmfmodes (id INTEGER AUTOINCREMENT PRIMARY KEY,name VARCHAR(16) NOT NULL DEFAULT '');
INSERT INTO sip_dtmfmodes VALUES(1,'rfc2833');
INSERT INTO sip_dtmfmodes VALUES(2,'inband');
INSERT INTO sip_dtmfmodes VALUES(3,'info');
...
INSERT INTO sip_trunks VALUES(0,'Any Trunk','','','','',0,'');
CREATE TABLE sip_codecs (id INTEGER AUTOINCREMENT PRIMARY KEY,name VARCHAR(64) NOT NULL DEFAULT '');
INSERT INTO sip_codecs VALUES(1,'all');
INSERT INTO sip_codecs VALUES(2,'alaw');
INSERT INTO sip_codecs VALUES(3,'gsm');
INSERT INTO sip_codecs VALUES(4,'ilbc');
INSERT INTO sip_codecs VALUES(5,'ulaw');
...
INSERT INTO rules_action VALUES(0,'none');
INSERT INTO rules_action VALUES(1,'dial');
INSERT INTO rules_action VALUES(2,'hangup');
INSERT INTO rules_action VALUES(3,'voicemail');
INSERT INTO rules_action VALUES(4,'disa');
CREATE TABLE rules_type (id INTEGER AUTOINCREMENT PRIMARY KEY,name VARCHAR(16) NOT NULL DEFAULT '');
INSERT INTO rules_type VALUES(1,'inbound');
INSERT INTO rules_type VALUES(2,'outbound');
