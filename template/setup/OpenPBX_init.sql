...
CREATE TABLE sip_users (id INTEGER AUTOINCREMENT PRIMARY KEY,name VARCHAR(64) NOT NULL DEFAULT '',extension INTEGER NOT NULL DEFAULT '0',password VARCHAR(256) NOT NULL DEFAULT '',voicemail INTEGER(1) NOT NULL DEFAULT 0,mail VARCHAR(256) NOT NULL DEFAULT '',language VARCHAR(5) NOT NULL DEFAULT 'en',details VARCHAR(512) NOT NULL DEFAULT '',CONSTRAINT fk_sip_extensions_id FOREIGN KEY(extension) REFERENCES sip_extensions(id) ON DELETE SET DEFAULT);
