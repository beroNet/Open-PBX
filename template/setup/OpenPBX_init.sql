...
CREATE TABLE disa (id INTEGER AUTOINCREMENT PRIMARY KEY,extension INTEGER NOT NULL DEFAULT '0',password VARCHAR(256) NOT NULL DEFAULT '',CONSTRAINT fk_sip_extensions_id FOREIGN KEY(extension) REFERENCES sip_extensions(id) ON DELETE SET DEFAULT);
COMMIT;
